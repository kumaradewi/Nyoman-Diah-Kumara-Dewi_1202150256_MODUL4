package com.example.kumaradewi.nyomandiahkumaradewi_1202150256_studycase4;
...
public class ListMahasiswa extends AppCompatActivity implements View.OnClickListener {
    ...
    private String[] namaMahasiswa = {"Nyoman", "Diah", "Kumara", "Dewi", "Angel", "Ade", "Paulin",
            "Boo Dat", "Aga Tha", "Song jong Ara", "Min Ara", "Ji Young Ara", "Do Hye Ara", "Ruko", "Tata", "Linara", "Alex", "Baby Ara"};
